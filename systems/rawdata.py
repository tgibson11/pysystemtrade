...
class RawData(SystemStage):
    ...
    def neg_skew(self, instrument_code, lookback_days=365):
        return -self.skew(instrument_code, lookback_days=lookback_days)
    ...
    def get_factor_value_for_instrument(self, instrument_code, factor_name="skew", **kwargs):
        ...
        try:
            ...
            self.log.error(f"Factor {factor_name} is not a method in rawdata stage")
            raise
    ...
    @output()
    def get_demeaned_factor_value(self, instrument_code, factor_name="skew",
