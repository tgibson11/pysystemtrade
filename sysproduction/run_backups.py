...
from sysproduction.backup_csv_data_to_remote import backupCsv
...
def get_list_of_timer_functions_for_backup():
    ...
    data_csv_backup = dataBlob(log_name="backup_csv_to_remote")
    ...
    csv_backup_object = backupCsv(data_csv_backup)
